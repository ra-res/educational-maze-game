...
/**
 * Class Constants is used to store public final variables Mostly used for the
 * configuration side of the game (like a settings panel) Allows to easily edit
 * the different aspects of the game such as colour theme etc
 */
public class Constants {
        static public final GameRound GAME_ROUND = new GameRound();
        static public final String SCORE_PATH = "score.txt";
        static public final Timer TIMER = new Timer();
        static public boolean MASK_ON = true;
